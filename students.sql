...
(assign_id int not null auto_increment primary key,assign_name varchar(100));
...
stud_id int,
marks int not null ,
foreign key(assign_id) references assignment(assign_id) on update cascade on delete cascade);
